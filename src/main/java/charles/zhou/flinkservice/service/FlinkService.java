...
public class FlinkService {
    ...
    public void startFlinkJob() throws Exception {
        ...
        // 5. 丰富的算子和函数库
        // 过滤出包含 "user1" 的数据
        DataStream<Tuple2<String, String>> filteredStream = userStream.filter(new org.apache.flink.api.common.functions.FilterFunction<Tuple2<String, String>>() {
            @Override
            public boolean filter(Tuple2<String, String> tuple) throws Exception {
                return tuple.f0.contains("user1");
            }
        });
